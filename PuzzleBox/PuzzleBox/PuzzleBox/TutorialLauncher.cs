...
namespace PuzzleBox
{
    ...
    class TutorialLauncher
    {
        ...
        public void Draw()
        {
            ...
            {
                JellyfishRenderer.DrawJellyfish(jellyX, jellyY, 100, JellyfishRenderer.orangeJelly, 1f, SpriteEffects.None);
            }
            if (state == TutorialLauncherState.ZOOM)
            {
                JellyfishRenderer.DrawJellyfish(jellyX, jellyY, 100, JellyfishRenderer.orangeJelly, (1f * animateTime) / (1f * maxAnimateTime), SpriteEffects.None);
            }
